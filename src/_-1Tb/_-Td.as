...
package 1Tb{
    ...
    public class Td extends ak {

        public function Td(_arg1:Console){
            super(_arg1);
        }
        ...
        private function 0cG(_arg1, _arg2:String, _arg3:int, _arg4:int):String{
            return (((_arg2 + ":") + this.explode(_arg1[_arg2], (_arg3 - 1), (_arg4 - 1))));
        }

        public function 0d9(_arg1:int, _arg2:int):String{
