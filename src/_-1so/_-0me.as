...
package 1so{
    ...
    public class 0me extends 0yC {

        public var map_:Map;

        public function 0me(_arg1:Map){
        ...
        private function getToolTip(_arg1:GameObject, _arg2:int):1ae{
        ...
        private function Bx(_arg1:int):Boolean{
            ...
            return (((01-) || (_local2.isNew(_arg1))));
        }

        override public function draw(_arg1:int, _arg2:1C8):void{
            var _local4:Boolean;
            var _local5:Boolean;
