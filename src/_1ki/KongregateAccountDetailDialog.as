...
//1ki.KongregateAccountDetailDialog
...
package 1ki{
    ...
    public class KongregateAccountDetailDialog extends Sprite {
        ...
        public function 00K(_arg1:String, _arg2:String, _arg3:Boolean):void{
            var _local4:Frame;
            _local4 = new Frame(du.0ct, "", du.Ym, "/kongregateCurrentLogin");
            addChild(_local4);
            this.1Bh = new _13j().setSize(18).setColor(0xB3B3B3);
            this.1Bh.setBold(true);
            this.1Bh.setStringBuilder(new 1cA().setParams(du.0ct));
            ...
            if (_arg3)
            {
                ...
                this.1QU.setStringBuilder(new 1cA().setParams(du.11V));
                this.1QU.filters = [new DropShadowFilter(0, 0, 0)];
                this.1QU.y = (_local4.h_ - 60);
                this.1QU.x = 17;
                _local4.addChild(this.1QU);
                this.ow = new _13j().setSize(16).setColor(0xB3B3B3).setTextWidth(238).setTextHeight(30);
