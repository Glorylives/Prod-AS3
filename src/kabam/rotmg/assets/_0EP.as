...
package kabam.rotmg.assets{
    public class _0EP {
        ...
        private static var _1KV:Class = EmbeddedAssets_labTankEmbed_;
        private static var _0Xb:Class = EmbeddedAssets_teslaEmbed_;
        private static var _0yF:Class = EmbeddedAssets_gasEmitter_;
        private static var _1xd:Class = EmbeddedAssets_cloningVatEmbed_;
        private static var DF:Class = EmbeddedAssets_crateEmbed_;
        private static var _8M:Class = EmbeddedAssets_threeSideCubeEmbed_;
        private static var _1PL:Class = EmbeddedAssets_squatty3Side_;
        private static var _0Xy:Class = EmbeddedAssets_cubeEmbed_;
        private static var mr:Class = EmbeddedAssets_bigcubeEmbed_;
        private static var QD:Class = EmbeddedAssets_icosahedronEmbed_;
        private static var DY:Class = EmbeddedAssets_octahedronEmbed_;
        private static var _9t:Class = EmbeddedAssets_pyramidEmbed_;
        private static var _implements:Class = EmbeddedAssets_tetrahedronEmbed_;
        private static var _1SW:Class = EmbeddedAssets_dodecahedronEmbed_;
        private static var _26K:Class = EmbeddedAssets_pillarEmbed_;
        private static var _0IH:Class = EmbeddedAssets_brokenPillarEmbed_;
        private static var _1Da:Class = EmbeddedAssets_towerEmbed_;
        private static var _08l:Class = EmbeddedAssets_obeliskEmbed_;
        private static var _0ga:Class = EmbeddedAssets_tableEmbed_;
        private static var _14f:Class = EmbeddedAssets_tableEdgeEmbed_;
        private static var _0CB:Class = EmbeddedAssets_signEmbed_;
        private static var _0OI:Class = EmbeddedAssets_webEmbed_;
        private static var _0KA:Class = EmbeddedAssets_twoHighWall_;
        private static var _1Ne:Class = EmbeddedAssets_columnOneAndHalfEmbed_;
        private static var _14Z:Class = EmbeddedAssets_candyColBrokenEmbed_;
        private static var _0f8:Class = EmbeddedAssets_candyColWholeEmbed_;
        ...
        private static var _0Ce:Class = EmbeddedAssets_newGateEmbed_;
        private static var _1CE:Class = EmbeddedAssets_newGateEntryEmbed_;
        private static var _0We:Class = EmbeddedAssets_newGateEntry2Embed_;
        ...
        private static var _188:Class = EmbeddedAssets_jackoEmbed_;
        private static var _1SG:Class = EmbeddedAssets_petUpgrader_;
        ...
        public static var _0O:Object = {
            ...
            "CloningVat":new _1xd(),
            "Crate":new DF(),
            "ThreeSideCube":new _8M(),
            "Squatty3Side":new _1PL(),
            "Cube":new _0Xy(),
            "Big Cube":new mr(),
            "Ico":new QD(),
            "Octa":new DY(),
            "Pyramid":new _9t(),
            "Tetra":new _implements(),
            "Dodec":new _1SW(),
            "Pillar":new _26K(),
            "Broken Pillar":new _0IH(),
            "Tower":new _1Da(),
            "Obelisk":new _08l(),
            "Table":new _0ga(),
            "Table Edge":new _14f(),
            "Sign":new _0CB(),
            "Web":new _0OI(),
            "Candy Col Broken":new _14Z(),
            "Candy Col Whole":new _0f8(),
            "Column One and a Half":new _1Ne(),
            "Two High Wall":new _0KA(),
