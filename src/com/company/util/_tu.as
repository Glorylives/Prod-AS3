...
package com.company.util{
    ...
    public class _tu {
        ...
        public static const _0xS:Vector.<int> = new <int>[GraphicsPathCommand.MOVE_TO, GraphicsPathCommand.LINE_TO, GraphicsPathCommand.LINE_TO, GraphicsPathCommand.LINE_TO];
        public static const ot:GraphicsStroke = new GraphicsStroke(1, false, LineScaleMode.NORMAL, CapsStyle.NONE, JointStyle.ROUND, 3, new GraphicsSolidFill(0xFF0000));
        public static const _1l4:GraphicsStroke = new GraphicsStroke();
        private static const _G:Number = (2 * Math.PI);//6.28318530717959
        public static const _0TX:Array = [true, true, true, true];


        public static function ln(_arg1:GraphicsPath):void{
            _arg1.commands.length = 0;
            _arg1.data.length = 0;
        }

        public static function _1s9(_arg1:int, _arg2:int, _arg3:int, _arg4:int):GraphicsPath{
            return (new GraphicsPath(_0xS, new <Number>[_arg1, _arg2, (_arg1 + _arg3), _arg2, (_arg1 + _arg3), (_arg2 + _arg4), _arg1, (_arg2 + _arg4)]));
        }

        public static function _1mc(_arg1:Number, _arg2:Number, _arg3:Number=0, _arg4:Number=0, _arg5:Number=0):Matrix{
        ...
        public static function drawCircle(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:GraphicsPath, _arg5:int=8):void{
            ...
            while (_local7 <= _arg5)
            {
                _local8 = ((_G * _local7) / _arg5);
                _local9 = ((_G * (_local7 - 0.5)) / _arg5);
        ...
        public static function _0S(_arg1:int, _arg2:int, _arg3:int, _arg4:int, _arg5:int, _arg6:Array, _arg7:GraphicsPath):void{
            if (_arg6[0] != 0)
            {
        ...
        public static function Jk(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:GraphicsPath):void{
