...
package com.company.util{
    public class Trig {
        ...
        public static const _1y:Number = (180 / Math.PI);//57.2957795130823
        public static const kP:Number = (Math.PI / 180);//0.0174532925199433

        public function Trig(_arg1:StaticEnforcer){
        }

        public static function wI(_arg1:Number, _arg2:Number, _arg3:Number):Number{
        ...
        public static function _0Z(_arg1:Number, _arg2:Number):Number{
            if (_arg1 > _arg2)
            {
                if ((_arg1 - _arg2) > Math.PI)
                {
        ...
        public static function _1VN(_arg1:Number):Number{
            var _local2:int;
            if (_arg1 < -(Math.PI))
            {
        ...
        public static function AR(_arg1:Number):Number{
            var _local2:int;
            if (_arg1 < -180)
            {
        ...
        public static function _1Qm():Boolean{
        ...
        public static function testFunc1(_arg1:Function, _arg2:Function):Boolean{
            ...
            while (_local4 < 1000)
            {
                _local5 = (((_local3._0Vw() % 2000) - 1000) + _local3._1o9());
        ...
        public static function testFunc2(_arg1:Function, _arg2:Function):Boolean{
            ...
            {
                _local5 = (((_local3._0Vw() % 2000) - 1000) + _local3._1o9());
                _local6 = (((_local3._0Vw() % 2000) - 1000) + _local3._1o9());
