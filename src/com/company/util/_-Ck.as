...
package com.company.util{
    ...
    public class Ck {
        ...
        public static function 18O(_arg1:Rectangle, _arg2:Number, _arg3:Number):Number{
        ...
        public static function 0Co(_arg1:Rectangle, _arg2:Number, _arg3:Number):Point{
            var _local4:Number = _arg2;
            var _local5:Number = _arg3;
            if (_local4 < _arg1.x)
            {
        ...
        public static function 03C(_arg1:Rectangle, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number):Boolean{
            var _local8:Number;
            var _local9:Number;
            var _local10:Number;
            var _local11:Number;
        ...
        public static function 1c(_arg1:Rectangle, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Point):Boolean{
            var _local7:Number;
            var _local8:Number;
            var _local9:Number;
            var _local10:Number;
        ...
        public static function 1Dz(_arg1:Rectangle, _arg2:IntPoint, _arg3:IntPoint):Point{
            var _local4:Number;
            var _local5:Number;
            var _local6:Number;
            var _local7:Number;
        ...
        public static function 0aW(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number):25C{
            var _local9:Point;
            var _local11:int;
