...
package com.company.util{
    ...
    public class 0JZ {
        ...
        private static function Ol(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Number, _arg7:Number, _arg8:Number):Boolean{
            var _local11:Number;
            var _local12:Number;
            var _local13:Number;
            var _local14:Number;
        ...
        public function xJ(_arg1:Point):void{
            var _local2:Number = PointUtil.Fg(this.x1_, this.y1_, this.x2_, this.y2_);
            var _local3:Number = PointUtil.Fg(this.x0_, this.y0_, this.x2_, this.y2_);
            var _local4:Number = PointUtil.Fg(this.x0_, this.y0_, this.x1_, this.y1_);
