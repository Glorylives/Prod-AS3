...
package com.company.assembleegameclient.objects{
    ...
    public class DoubleWall extends GameObject {
        ...
        private static const _0cT:Vector.<Number> = new <Number>[0, 0, 0, 1, 0, 0, 1, 2, 0, 0, 2, 0];
        ...
        override public function draw(_arg1:Vector.<IGraphicsData>, _arg2:_1C8, _arg3:int):void{
            ...
            while (_local5 < this.faces_.length)
            {
                ...
                if ((((((_local8 == null)) || ((_local8.texture_ == null)))) || (((((!((_local8 == null))) && ((_local8.obj_ is DoubleWall)))) && (!(_local8.obj_.RK))))))
                {
                    _local7._0XV = true;
                } else
                {
        ...
        public function Me():void{
            ...
            this._0gI(_local1, _local2, 2, (_local1 + 1), _local2, 2);
            this._0gI((_local1 + 1), _local2, 2, (_local1 + 1), (_local2 + 1), 2);
            this._0gI((_local1 + 1), (_local2 + 1), 2, _local1, (_local2 + 1), 2);
            this._0gI(_local1, (_local2 + 1), 2, _local1, _local2, 2);
        }
        ...
        private function _0gI(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Number):void{
            ...
            var _local8:Face3D = new Face3D(texture_, _local7, _0cT, true, true);
