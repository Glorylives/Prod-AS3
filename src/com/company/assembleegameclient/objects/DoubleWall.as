...
package com.company.assembleegameclient.objects{
    ...
    public class DoubleWall extends GameObject {
        ...
        private static const 0cT:Vector.<Number> = new <Number>[0, 0, 0, 1, 0, 0, 1, 2, 0, 0, 2, 0];
        ...
        public function Me():void{
            ...
            this.0gI(_local1, _local2, 2, (_local1 + 1), _local2, 2);
            this.0gI((_local1 + 1), _local2, 2, (_local1 + 1), (_local2 + 1), 2);
            this.0gI((_local1 + 1), (_local2 + 1), 2, _local1, (_local2 + 1), 2);
            this.0gI(_local1, (_local2 + 1), 2, _local1, _local2, 2);
        }
        ...
        private function 0gI(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Number):void{
            ...
            var _local8:Face3D = new Face3D(texture_, _local7, 0cT, true, true);
