...
public class Merchant extends SellableObject implements _18p {
    ...
    private static const _lx:int = 2;
    ...
    public var _wT:int = -1;
    public var _00c:int = -1;
    public var _yl:int = 0;
    ...
    public function _0VI(_arg1:int):_Wl{
        var _local2:_1cA;
        var _local3:uint;
        var _local4:uint;
        var _local5:uint;
        switch (_arg1)
        {
            ...
            } else
            {
                ...
                break;
            case _0Tw:
                    _local2 = new _1cA().setParams("Merchant.limitedStock", {count:this._wT});
                _local3 = 5973542;
                _local4 = 16549442;
                _local5 = 16549442;
                break;
            case _1UR:
                    _local2 = new _1cA().setParams("Merchant.discount", {discount:this._yl});
                _local3 = 6324275;
                _local4 = 16777103;
                _local5 = 16777103;
                break;
