...
package com.company.assembleegameclient.objects{
    ...
    public class Stalagmite extends GameObject {
        ...
        public function Stalagmite(_arg1:XML){
            ...
            _0rb = new _0oE();
            _0rb.vL_.push((Math.cos(_local2) * 0.3), (Math.sin(_local2) * 0.3), 0, (Math.cos(_local3) * 0.3), (Math.sin(_local3) * 0.3), 0, (Math.cos(_local4) * 0.3), (Math.sin(_local4) * 0.3), 0, 0, 0, (0.6 + (0.6 * Math.random())));
            _0rb.faces_.push(new ObjectFace3D(_0rb, new <int>[0, 1, 3]), new ObjectFace3D(_0rb, new <int>[1, 2, 3]), new ObjectFace3D(_0rb, new <int>[2, 0, 3]));
            _0rb.uvts_.push(0, 1, 0, 0.5, 1, 0, 1, 1, 0, 0.5, 0, 0);
        }
