...
package com.company.assembleegameclient.util{
    ...
    import com.company.assembleegameclient.map._0s6;
    import com.company.assembleegameclient.map.Square;
    import com.company.assembleegameclient.map.Map;
    import com.company.util.AssetLibrary;
    import com.company.util.BitmapUtil;
    import com.company.assembleegameclient.map._1je;
    ...
    public class _0Sw {
        ...
        private static const _0IU:int = 0;
        ...
        private static function _1tK(_arg1:BitmapData, _arg2:Rectangle, _arg3:Point, _arg4:Vector.<J2>, _arg5:uint, _arg6:uint, _arg7:uint, _arg8:uint):void{
            ...
            {
                _local10 = _arg4[_0zT].random();
                _local9 = _0s6.getBitmapData(_arg7);
            } else
            {
                if (((!((_arg5 == _arg6))) && (!((_arg5 == _arg8)))))
                {
        ...
        private static function _0Ib(_arg1:Square):ByteArray{
            var _local6:int;
            var _local7:Square;
        ...
        private static function _0o9(_arg1:Square):ByteArray{
            var _local14:Square;
            var _local15:Square;
            var _local16:Square;
            var _local17:Square;
            ...
            var _local10:int = (((_local6)!=null) ? _local6.props_._0Qw : -1);
            var _local11:int = (((_local7)!=null) ? _local7.props_._0Qw : -1);
            var _local12:int = (((_local8)!=null) ? _local8.props_._0Qw : -1);
            var _local13:int = (((_local9)!=null) ? _local9.props_._0Qw : -1);
            if ((((_local10 < 0)) && ((_local11 < 0))))
            {
                _local14 = _local3.lookupSquare((_local4 - 1), (_local5 - 1));
                _local2[0] = (((((_local14 == null)) || ((_local14.props_._0Qw < 0)))) ? 0xFF : _local14.tileType_);
            } else
            {
            ...
            if ((((_local10 < 0)) && ((_local12 < 0))))
            {
                ...
                _local2[1] = (((((_local15 == null)) || ((_local15.props_._0Qw < 0)))) ? 0xFF : _local15.tileType_);
            } else
            {
            ...
            if ((((_local11 < 0)) && ((_local13 < 0))))
            {
                ...
                _local2[2] = (((((_local16 == null)) || ((_local16.props_._0Qw < 0)))) ? 0xFF : _local16.tileType_);
            } else
            {
            ...
            if ((((_local12 < 0)) && ((_local13 < 0))))
            {
                ...
                _local2[3] = (((((_local17 == null)) || ((_local17.props_._0Qw < 0)))) ? 0xFF : _local17.tileType_);
            } else
            {
        ...
        private static function _21c(_arg1:ByteArray):BitmapData{
        ...
        private static function _10(_arg1:Square):ByteArray{
            var _local7:int;
            var _local8:Square;
            var _local9:Boolean;
            var _local2:ByteArray = new ByteArray();
            var _local3:Map = _arg1.map_;
            var _local4:Boolean;
            var _local5:Boolean = _arg1.props_._1j7;
        ...
        private static function _1Pf(_arg1:ByteArray):BitmapData{
            var _local2:BitmapData = _0s6.getBitmapData(_arg1[4]);
            var _local3:BitmapData = _local2.clone();
            var _local4:_1je = _0s6._0Ri[_arg1[4]];
            var _local5:Vector.<BitmapData> = _local4._1SF();
