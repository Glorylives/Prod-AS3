...
package com.company.assembleegameclient.util{
    ...
    public class TextureRedrawer {
        ...
        public static const _0XU:int = 12;
        public static const _1hO:int = (2 * _0XU);//24
        ...
        private static var _0mk:Dictionary = new Dictionary();
        private static var _02m:Dictionary = new Dictionary();
        public static var _1kd:BitmapData = null;
        ...
        private static var colorTexture1:BitmapData = new HL(1, 1, false);
        private static var colorTexture2:BitmapData = new HL(1, 1, false);
        ...
        public static function redraw(_arg1:BitmapData, _arg2:int, _arg3:Boolean, _arg4:uint, _arg5:Boolean=true, _arg6:Number=5):BitmapData{
            ...
            if (((_arg5) && (_0bK(_arg1, _local7))))
            {
                return (_02m[_arg1][_local7]);
            }
            var _local8:BitmapData = resize(_arg1, null, _arg2, _arg3, 0, 0, _arg6);
            _local8 = _1go._0Lr(_local8, _arg4, 1.4, _arg5);
            if (_arg5)
            {
                _0Yu(_arg1, _local7, _local8);
            }
            return (_local8);
        }
        ...
        private static function _0Yu(_arg1:BitmapData, _arg2:String, _arg3:BitmapData):void{
            if (!(_arg1 in _02m))
            {
                _02m[_arg1] = {}
            }
            _02m[_arg1][_arg2] = _arg3;
        }

        private static function _0bK(_arg1:BitmapData, _arg2:String):Boolean{
            if ((_arg1 in _02m))
            {
                if ((_arg2 in _02m[_arg1]))
                {
                    return (true);
                }
            }
        ...
        public static function resize(_arg1:BitmapData, _arg2:BitmapData, _arg3:int, _arg4:Boolean, _arg5:int, _arg6:int, _arg7:Number=5):BitmapData{
            ...
            _local10.translate(_0XU, _0XU);
            var _local11:BitmapData = new HL((_local8 + _1hO), ((_local9 + ((_arg4) ? _0XU : 1)) + _0XU), true, 0);
        ...
        public static function redrawSolidSquare(_arg1:uint, _arg2:int):BitmapData{
            ...
            _local4 = new HL(((_arg2 + 4) + 4), ((_arg2 + 4) + 4), true, 0);
            _local4.fillRect(new Rectangle(4, 4, _arg2, _arg2), (0xFF000000 | _arg1));
            _local4.applyFilter(_local4, _local4.rect, PointUtil._1EH, OUTLINE_FILTER);
        ...
        public static function WQ(_arg1:BitmapData, _arg2:Number):BitmapData{
            if (_arg2 == 1)
            {
                return (_arg1);
            }
            var _local3:Dictionary = _0mk[_arg2];
            if (_local3 == null)
            {
                _local3 = new Dictionary();
                _0mk[_arg2] = _local3;
        ...
        private static function getTexture(_arg1:int, _arg2:BitmapData):BitmapData{
            ...
            switch (_local4)
            {
                ...
                case 1:
                    ...
                    break;
                case 4:
                    _local3 = AssetLibrary._1JR("textile4x4", _local5);
                    break;
                case 5:
                    _local3 = AssetLibrary._1JR("textile5x5", _local5);
                    break;
                case 9:
                    _local3 = AssetLibrary._1JR("textile9x9", _local5);
                    break;
                case 10:
                    _local3 = AssetLibrary._1JR("textile10x10", _local5);
                    break;
                case 0xFF:
                    _local3 = _1kd;
                    break;
        ...
        private static function retexture(_arg1:BitmapData, _arg2:BitmapData, _arg3:int, _arg4:int):BitmapData{
            ...
            _local5.scale(5, 5);
            var _local6:BitmapData = new HL((_arg1.width * 5), (_arg1.height * 5), true, 0);
            ...
            _local6.applyFilter(_local6, _local6.rect, PointUtil._1EH, new ShaderFilter(_local9));
            return (_local6);
        }
