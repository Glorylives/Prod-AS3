...
//com.company.assembleegameclient.util.0Sw
...
package com.company.assembleegameclient.util{
    ...
    import com.company.assembleegameclient.map.1je;
    ...
    public class 0Sw {
        ...
        public static function redraw(_arg1:Square, _arg2:Boolean):BitmapData{
            ...
            var _local4:Object = cache_[Parameters.1tu];
            ...
            var _local10:BitmapData = 0s6.getBitmapData(_arg1.tileType_);
            if (_arg2)
            {
            ...
            if (_local6)
            {
                1tK(_local5, rect0, p0, MV[0], _local3[4], _local3[3], _local3[0], _local3[1]);
            };
            if (_local7)
            {
                1tK(_local5, rect1, p1, MV[1], _local3[4], _local3[1], _local3[2], _local3[5]);
            };
            if (_local8)
            {
                1tK(_local5, rect2, p2, MV[2], _local3[4], _local3[7], _local3[6], _local3[3]);
            };
            if (_local9)
            {
                1tK(_local5, rect3, p3, MV[3], _local3[4], _local3[5], _local3[8], _local3[7]);
            };
            _local4[_local3] = _local5;
            return (_local5);
        }

        private static function 1tK(_arg1:BitmapData, _arg2:Rectangle, _arg3:Point, _arg4:Vector.<J2>, _arg5:uint, _arg6:uint, _arg7:uint, _arg8:uint):void{
            var _local9:BitmapData;
            var _local10:BitmapData;
            if ((((_arg5 == _arg6)) && ((_arg5 == _arg8))))
            {
                _local10 = _arg4[0zT].random();
                _local9 = 0s6.getBitmapData(_arg7);
            } else
            {
                if (((!((_arg5 == _arg6))) && (!((_arg5 == _arg8)))))
                {
                    if (_arg6 != _arg8)
                    {
                        _arg1.copyPixels(0s6.getBitmapData(_arg6), _arg2, _arg3, _arg4[INNERP1].random(), p0, true);
                        _arg1.copyPixels(0s6.getBitmapData(_arg8), _arg2, _arg3, _arg4[INNERP2].random(), p0, true);
                        return;
                    };
                    _local10 = _arg4[0IU].random();
                    _local9 = 0s6.getBitmapData(_arg6);
                } else
                {
                    if (_arg5 != _arg6)
                    {
                    ...
                    } else
                    {
                        ...
                        _local9 = 0s6.getBitmapData(_arg8);
                    };
                };
            };
        ...
        private static function 0Ib(_arg1:Square):ByteArray{
            var _local6:int;
            var _local7:Square;
            ...
            while (_local5 <= (_arg1.y_ + 1))
            {
                ...
                while (_local6 <= (_arg1.x_ + 1))
                {
                    ...
                    } else
                    {
                        ...
                        if ((((_local7 == null)) || ((_local7.props_.ie <= _arg1.props_.ie))))
                        {
                            _local2.writeByte(_local4);
                        } else
                        {
        ...
        private static function 127():Vector.<Vector.<J2>>{
            var _local1:Vector.<Vector.<J2>> = new Vector.<Vector.<J2>>();
            1vG(_local1, AssetLibrary.0wJ("inner_mask"), AssetLibrary.0wJ("sides_mask"), AssetLibrary.0wJ("outer_mask"), AssetLibrary.0wJ("innerP1_mask"), AssetLibrary.0wJ("innerP2_mask"));
            return (_local1);
        }

        private static function 1vG(_arg1:Vector.<Vector.<J2>>, _arg2:J2, _arg3:J2, _arg4:J2, _arg5:J2, _arg6:J2):void{
            var _local7:int;
            for each (_local7 in [-1, 0, 2, 1])
            {
                _arg1.push(new <J2>[1V8(_arg2, _local7), 1V8(_arg3, (_local7 - 1)), 1V8(_arg3, _local7), 1V8(_arg4, _local7), 1V8(_arg5, _local7), 1V8(_arg6, _local7)]);
            };
        }

        private static function 1V8(_arg1:J2, _arg2:int):J2{
            var _local4:BitmapData;
            var _local3:J2 = new J2();
            for each (_local4 in _arg1.7D)
            {
                _local3.add(BitmapUtil.0E6(_local4, _arg2));
            };
            return (_local3);
        }

        private static function 0o9(_arg1:Square):ByteArray{
            var _local14:Square;
            var _local15:Square;
            var _local16:Square;
            var _local17:Square;
            ...
            var _local10:int = (((_local6)!=null) ? _local6.props_.0Qw : -1);
            var _local11:int = (((_local7)!=null) ? _local7.props_.0Qw : -1);
            var _local12:int = (((_local8)!=null) ? _local8.props_.0Qw : -1);
            var _local13:int = (((_local9)!=null) ? _local9.props_.0Qw : -1);
            if ((((_local10 < 0)) && ((_local11 < 0))))
            {
                _local14 = _local3.lookupSquare((_local4 - 1), (_local5 - 1));
                _local2[0] = (((((_local14 == null)) || ((_local14.props_.0Qw < 0)))) ? 0xFF : _local14.tileType_);
            } else
            {
            ...
            if ((((_local10 < 0)) && ((_local12 < 0))))
            {
                ...
                _local2[1] = (((((_local15 == null)) || ((_local15.props_.0Qw < 0)))) ? 0xFF : _local15.tileType_);
            } else
            {
            ...
            if ((((_local11 < 0)) && ((_local13 < 0))))
            {
                ...
                _local2[2] = (((((_local16 == null)) || ((_local16.props_.0Qw < 0)))) ? 0xFF : _local16.tileType_);
            } else
            {
            ...
            if ((((_local12 < 0)) && ((_local13 < 0))))
            {
                ...
                _local2[3] = (((((_local17 == null)) || ((_local17.props_.0Qw < 0)))) ? 0xFF : _local17.tileType_);
            } else
            {
        ...
        private static function 21c(_arg1:ByteArray):BitmapData{
            var _local3:BitmapData;
            var _local2:BitmapData = new HL(8, 8, false, 0);
            if (_arg1[0] != 0xFF)
            {
                _local3 = 0s6.getBitmapData(_arg1[0]);
                _local2.copyPixels(_local3, RECT0, POINT0);
            };
            if (_arg1[1] != 0xFF)
            {
                _local3 = 0s6.getBitmapData(_arg1[1]);
                _local2.copyPixels(_local3, RECT1, POINT1);
            };
            if (_arg1[2] != 0xFF)
            {
                _local3 = 0s6.getBitmapData(_arg1[2]);
                _local2.copyPixels(_local3, RECT2, POINT2);
            };
            if (_arg1[3] != 0xFF)
            {
                _local3 = 0s6.getBitmapData(_arg1[3]);
                _local2.copyPixels(_local3, RECT3, POINT3);
            };
            return (_local2);
        }

        private static function 10-(_arg1:Square):ByteArray{
            var _local7:int;
            var _local8:Square;
            var _local9:Boolean;
            var _local2:ByteArray = new ByteArray();
            var _local3:Map = _arg1.map_;
            var _local4:Boolean;
            var _local5:Boolean = _arg1.props_.1j7;
        ...
        private static function 1Pf(_arg1:ByteArray):BitmapData{
            var _local2:BitmapData = 0s6.getBitmapData(_arg1[4]);
            var _local3:BitmapData = _local2.clone();
            var _local4:1je = 0s6.0Ri[_arg1[4]];
            var _local5:Vector.<BitmapData> = _local4.1SF();
            var _local6:Vector.<BitmapData> = _local4.TB();
            var _local7:int = 1;
            while (_local7 < 8)
            {
                if (!_arg1[_local7])
                {
                    _local3.copyPixels(_local5[_local7], _local5[_local7].rect, PointUtil.1EH, null, null, true);
                };
                _local7 = (_local7 + 2);
            };
            if (_local5[0] != null)
            {
                ...
                {
                    _local3.copyPixels(_local5[0], _local5[0].rect, PointUtil.1EH, null, null, true);
                };
                if (((((_arg1[1]) && (_arg1[5]))) && (!(_arg1[2]))))
                {
                    _local3.copyPixels(_local5[2], _local5[2].rect, PointUtil.1EH, null, null, true);
                };
                if (((((_arg1[5]) && (_arg1[7]))) && (!(_arg1[8]))))
                {
                    _local3.copyPixels(_local5[8], _local5[8].rect, PointUtil.1EH, null, null, true);
                };
                if (((((_arg1[3]) && (_arg1[7]))) && (!(_arg1[6]))))
                {
                    _local3.copyPixels(_local5[6], _local5[6].rect, PointUtil.1EH, null, null, true);
                };
            };
            if (_local6 != null)
            {
                if (((!(_arg1[3])) && (!(_arg1[1]))))
                {
                    _local3.copyPixels(_local6[0], _local6[0].rect, PointUtil.1EH, null, null, true);
                };
                if (((!(_arg1[1])) && (!(_arg1[5]))))
                {
                    _local3.copyPixels(_local6[2], _local6[2].rect, PointUtil.1EH, null, null, true);
                };
                if (((!(_arg1[5])) && (!(_arg1[7]))))
                {
                    _local3.copyPixels(_local6[8], _local6[8].rect, PointUtil.1EH, null, null, true);
                };
                if (((!(_arg1[3])) && (!(_arg1[7]))))
                {
                    _local3.copyPixels(_local6[6], _local6[6].rect, PointUtil.1EH, null, null, true);
                };
            };
            return (_local3);
        }
