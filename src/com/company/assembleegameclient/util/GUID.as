...
package com.company.assembleegameclient.util{
    ...
    public class GUID {
        ...
        public static function create():String{
            ...
            return (16-((((_local2 + _local4) + _local3) + counter++)).toUpperCase());
        }

        private static function 16-(_arg1:String):String{
            return (73(_arg1));
        }

        private static function 73(_arg1:String):String{
            return (0pL(1ef(1FQ(_arg1), (_arg1.length * 8))));
        }

        private static function 1ef(_arg1:Array, _arg2:Number):Array{
            var _local10:Number;
            var _local11:Number;
            var _local12:Number;
            var _local13:Number;
            ...
            while (_local9 < _arg1.length)
            {
                ...
                while (_local15 < 80)
                {
                    ...
                    _local16 = 0Xg(0Xg(rol(_local4, 5), sha1_ft(_local15, _local5, _local6, _local7)), 0Xg(0Xg(_local8, _local3[_local15]), sha1_kt(_local15)));
                    _local8 = _local7;
                    _local7 = _local6;
                ...
                _local4 = 0Xg(_local4, _local10);
                _local5 = 0Xg(_local5, _local11);
                _local6 = 0Xg(_local6, _local12);
                _local7 = 0Xg(_local7, _local13);
                _local8 = 0Xg(_local8, _local14);
                _local9 = (_local9 + 16);
            };
        ...
        private static function 0Xg(_arg1:Number, _arg2:Number):Number{
        ...
        private static function 1FQ(_arg1:String):Array{
        ...
        private static function 0pL(_arg1:Array):String{
