...
package com.company.assembleegameclient.tutorial{
    ...
    public class UIDrawArrow {
        ...
        public function UIDrawArrow(_arg1:XML){
            var _local2:Array = ConversionUtil.eQ(_arg1);
            this.p0_ = _local2[0];
            this.p1_ = _local2[1];
        ...
        public function draw(_arg1:int, _arg2:Graphics, _arg3:int):void{
            ...
            if (_arg3 < this.AY)
            {
                _local4.x = (this.p0_.x + (((this.p1_.x - this.p0_.x) * _arg3) / this.AY));
                _local4.y = (this.p0_.y + (((this.p1_.y - this.p0_.y) * _arg3) / this.AY));
            } else
            {
            ...
            var _local5:Number = PointUtil.0qu(_local4, this.p0_);
            _local6 = PointUtil.6T(_local4, (_local5 + (Math.PI / 8)), 30);
