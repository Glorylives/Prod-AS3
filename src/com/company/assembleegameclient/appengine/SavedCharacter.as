    ...
    public class SavedCharacter {
        ...
        public function SavedCharacter(_arg1:XML, _arg2:String){
            ...
            if (this.gI.hasOwnProperty("Pet"))
            {
                ...
                _local5 = _1JZ.0JF().getInstance(zL).getPetVO(_local4);
        ...
        public static function getImage(_arg1:SavedCharacter, _arg2:XML, _arg3:int, _arg4:int, _arg5:Number, _arg6:Boolean, _arg7:Boolean):BitmapData{
            var _local8:_BJ = _V4.1Q2(String(_arg2.AnimatedTexture.File), int(_arg2.AnimatedTexture.Index));
            var _local9:0s0 = _local8.imageFromDir(_arg3, _arg4, _arg5);
            ...
            _local12 = 1go.0Lr(_local12, 0);
            if (!_arg6)
            {
                _local12 = hd.07J(_local12, new ColorTransform(0, 0, 0, 0.5, 0, 0, 0, 0));
            } else
            {
                if (!_arg7)
                {
                    _local12 = hd.07J(_local12, new ColorTransform(0.75, 0.75, 0.75, 1, 0, 0, 0, 0));
                };
            };
            return (_local12);
        }

        public static function 0Ys(_arg1:SavedCharacter, _arg2:SavedCharacter):Number{
        ...
        public function 0ki():String{
            return (ObjectLibrary.118[this.objectType()]);
        }
        ...
        public function BP(_arg1:0tK):void{
            this.pet = _arg1;
        }
