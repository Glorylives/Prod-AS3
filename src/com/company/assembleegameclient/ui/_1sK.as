...
package com.company.assembleegameclient.ui{
    ...
    import com.company.util._0IB;
    import com.company.assembleegameclient.util.GuildUtil;
    import _1n4._1WS;

    public class _1sK extends Sprite {
        ...
        public function _1sK(_arg1:String, _arg2:int, _arg3:int=0){
        ...
        public function draw(_arg1:String, _arg2:int):void{
            ...
            {
                _0IB._13h(this, this.e4);
                _0IB._13h(this, this.guildName_);
            } else
            {
                this.e4.bitmapData = GuildUtil.CW(this.qw, 20);
                _0IB._0pa(this, this.e4);
                this.guildName_.setStringBuilder(new _1WS(this.name_));
                _0IB._0pa(this, this.guildName_);
            }
        }
