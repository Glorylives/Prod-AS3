...
package com.company.assembleegameclient.screens.charrects{
    ...
    public class CharacterRect extends Sprite {
        ...
        protected var taglineText:_13j;
        protected var classNameText:_13j;
        protected var className:1Jo;
        ...
        protected function makeClassNameText():void{
            this.classNameText = new _13j().setSize(18).setColor(0xFFFFFF);
        ...
        protected function makeTaglineText(_arg1:1Jo):void{
            this.taglineText = new _13j().setSize(14).setColor(0xB3B3B3);
