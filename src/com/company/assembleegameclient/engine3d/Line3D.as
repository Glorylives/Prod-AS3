...
package com.company.assembleegameclient.engine3d{
    ...
    public class Line3D {
        ...
        public static function 1Qm():Boolean{
            return (UnitTest.run());
        }


        public function KJ(_arg1:Line3D):int{
        ...
        public function 1m0(_arg1:Number):Vector3D{
...
class UnitTest {
    ...
    private static function testCrossZ():Boolean{
        ...
        if (_local1.KJ(_local2) != Order.0Nj)
        {
            return (false);
        }
        if (_local2.KJ(_local1) != Order.yq)
        {
            return (false);
        }
