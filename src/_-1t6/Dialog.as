...
package 1t6{
    ...
    public class Dialog extends Sprite {
        ...
        protected const graphicsData_:Vector.<IGraphicsData> = new <flash.display.IGraphicsData>[Dialog.1F4, Dialog.0B9, Dialog.path_, com.company.util._tu.END_FILL, com.company.util._tu.1l4];
        ...
        public function 12Z(_arg1:String, _arg2:Object):void{
            this.a.setStringBuilder(new 1cA().setParams(_arg1, _arg2));
        }
        ...
        protected function initText(_arg1:String):void{
            ...
            this.a.setHTML(true);
            var _local2:1cA = new 1cA().setParams(_arg1).setPrefix('<p align="center">').setPostfix("</p>");
            if (this.1oW)
            {
