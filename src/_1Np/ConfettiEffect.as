...
package 1Np{
    ...
    public class ConfettiEffect extends 0F- {

        public var start_:Point;
        public var end_:Point;
        public var color_:int;
        public var lifetime_:int;
        public var 0Oq:Boolean = false;

        public function ConfettiEffect(_arg1:1tk, _arg2:1tk, _arg3:int, _arg4:int, _arg5:Boolean=false){
...
class ConfettiParticle extends Particle {
    ...
    override public function update(_arg1:int, _arg2:int):Boolean{
        ...
        rm((this.pathX_ + (this.xDeflect_ * _local3)), (this.pathY_ + (this.yDeflect_ * _local3)));
        return (true);
    }
