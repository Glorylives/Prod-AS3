...
package 1Np{
    ...
    public class Md extends Particle {
        ...
        public function Md(_arg1:int, _arg2:int, _arg3:int, _arg4:Point, _arg5:Point){
            super(_arg2, 0, _arg1);
        ...
        override public function update(_arg1:int, _arg2:int):Boolean{
            ...
            map_.addObj(new El((100 * (z_ + 1)), color_, 600, z_, 0Na.1Me(1), 0Na.1Me(1)), this.pathX_, this.pathY_);
            return (true);
        }
