...
package Jt{
    ...
    public class 4b {
        ...
        public static const 062:BitmapData = new BitmapData(1, 1, true, 0x888888FF);

        public var bk:192 = null;
        private var bitmapData:BitmapData;
        public var 0XA:Matrix3D;
        public var dr:Matrix3D;
        public var 0pu:Matrix3D;
        public var position:Vector3D;
        private var 1x4:Number;
        private var texture_:Texture;

        public function 4b(_arg1:192){
            this.bk = _arg1;
            this.0XA = new Matrix3D();
            this.dr = new Matrix3D();
            this.0pu = new Matrix3D();
        }

        public function 11F(_arg1:BitmapData):void{
            this.bitmapData = uo.wJ(_arg1);
        }
        ...
        public function UpdateModelMatrix(_arg1:Number, _arg2:Number):void{
            this.0XA.identity();
            this.0XA.appendRotation(-90, Vector3D.Z_AXIS);
            this.0XA.appendRotation(-(this.1x4), Vector3D.Z_AXIS);
            this.0XA.appendTranslation(this.position.x, this.position.y, 0);
            this.0XA.appendTranslation(_arg1, _arg2, 0);
        }
        ...
        public function draw(_arg1:Context3D):void{
            ...
            for each (_local2 in this.bk.27N)
            {
                if (_local2.1ck != null)
                {
                    _arg1.drawTriangles(_local2.1ck);
                };
            };
        }
