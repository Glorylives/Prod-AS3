...
package 0ao{
    ...
    public class 0Y2 implements 0bJ {

        private const uU:String = "rotmgtesting.appspot.com";
        private const 1km:String = ("http://" + 0Y2.uU);
        private const Z9:String = ("https://" + 0Y2.uU);
        private const q7:String = "UA-11236645-6";
        private const 1Bq:String = "<font color='#FF0000'>TESTING</font> #{VERSION}";
