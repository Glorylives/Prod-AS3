    ...
    public class 0Ih extends ak {
        ...
        public function 0Ih(_arg1:Console){
            ...
            remoter.registerCallback("log", function (_arg1:ByteArray):void{
                registerLog(_Dq.jk(_arg1));
            });
        }

        private function AP(_arg1:Event):void{
            var _local2:_Dq = this.first;
            while (_local2)
            {
                this.0ou(_local2);
        ...
        private function 0ou(_arg1:_Dq):void{
        ...
        public function add(_arg1:_Dq):void{
            this._lines++;
        ...
        private function registerLog(_arg1:_Dq):void{
            this.6e = true;
        ...
        private function push(_arg1:_Dq):void{
            if (this.last == null)
            {
                this.first = _arg1;
            } else
        ...
        private function remove(_arg1:_Dq):void{
            if (this.first == _arg1)
            {
