...
package _1Tb{
    ...
    public class Executer extends EventDispatcher {
        ...
        public static const _0PZ:String = "returned";
        public static const _0TO:String = "ExeValue|((com.junkbyte.console.core::)?Executer)";
        private static const nl:String = "#";

        private var _0w4:Array;
        private var H0:Boolean;
        private var xI;
        private var _0WH;
        private var _0au:Object;
        private var _0cs:Array;
        public var _1A4:Boolean;
        ...
        private function _0PA(_arg1:String):void{
            var _local5:String;
            var _local6:String;
            var _local7:String;
            var _local8:int;
            ...
            while (_local2 >= 0)
            {
                ...
                if (_arg1.substring((_local2 + 1), _local3).search(/\w/) >= 0)
                {
                    ...
                    if (_local7)
                    {
                        ...
                        {
                            _local10[_local11] = this._0lb(this._1FN(_local10[_local11])).value;
                        }
                    } else
                    {
                        _local12 = new ExeValue(_local12);
                        _arg1 = this.kG(_arg1, _local12, _local2, (_local5 + 1));
                        _local12.setValue(this._0lb(this._1FN(_local6)).value);
                    }
                }
                _local2 = _arg1.lastIndexOf("(", (_local2 - 1));
            }
            this._0WH = this._0lb(_arg1).value;
            if (((this._0WH) && (this._1A4)))
            {
                _local13 = typeof(this._0WH);
        ...
        private function kG(_arg1:String, _arg2, _arg3:int, _arg4:int):String{
            _arg1 = (((_arg1.substring(0, _arg3) + nl) + this._0w4.length) + _arg1.substring(_arg4));
            this._0w4.push(_arg2);
            return (_arg1);
        }

        private function _0lb(_arg1:String):ExeValue{
            var _local7:String;
            var _local8:*;
            var _local11:int;
            var _local12:int;
            ...
            } else
            {
                ...
                while (_local3 != null)
                {
                    ...
                    if (_local3 == null)
                    {
                        ...
                        _local4.push(this._1FN(_local13));
            ...
            {
                _local4[_local6] = this._0Dz(_local4[_local6]);
                _local6 = (_local6 + 2);
            }
            var _local9:RegExp = /((\|\||\&\&|[+|\-|*|\/|\%|\||\&|\^]|\>\>\>?|\<\<)\=)|=/;
            _local6 = 1;
            while (_local6 < _local5)
            {
                ...
                {
                    _local8 = this._0j5(_local4[(_local6 - 1)], _local7, _local4[(_local6 + 1)]);
            ...
            while (_local6 < _local5)
            {
                ...
                if (_local7.replace(_local9, "") == "")
                {
                    ...
                    _local8 = this._0j5(_local15, _local7, _local10);
        ...
        private function _0Dz(_arg1:String):ExeValue{
            ...
            if (firstparts.length > 0)
            {
                while (firstparts.length)
                {
                    ...
                    try
                    {
                        def = getDefinitionByName(this._1FN(classstr));
            ...
            while (result != null)
            {
                ...
                basestr = this._1FN(str.substring(previndex, index));
                    ...
                    } else
                    {
                        ...
                        } else
                        {
                            ...
                            } else
                            {
                                if (str.indexOf(nl) == 0)
                                {
                                    vv = this._0w4[str.substring(nl.length)];
                                    v.obj = vv.value;
                                } else
                                {
                                    if (str.charAt(0) == "$")
        ...
        private function _0j5(_arg1:ExeValue, _arg2:String, _arg3:ExeValue){
            switch (_arg2)
            {
                case "=":
                    return (_arg3.value);
        ...
        private function _1FN(_arg1:String):String{
